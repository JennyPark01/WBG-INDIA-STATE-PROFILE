...
pfr_data <- read.csv("C:/Users/jaeye/Downloads/WB/State profile/pfr_1_1_data.csv",
                     stringsAsFactors = FALSE)

# Revenues (PFR 2_1)
pfr_2_1_data <- read.csv("C:/Users/jaeye/Downloads/WB/State profile/pfr_2_1_data.csv",
                         stringsAsFactors = FALSE)

# Expenditure (PFR 3_1)
pfr_3_1_data <- read.csv("C:/Users/jaeye/Downloads/WB/State profile/pfr_3_1_data.csv",
                         stringsAsFactors = FALSE)

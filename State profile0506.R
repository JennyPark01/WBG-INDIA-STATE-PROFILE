...
################################################################################
# Project : State Profile  - Fiscal Dashboard
...
intro_section1 <- read.csv("C:/Users/jaeye/Downloads/WB/State profile/Intro/section1-30july.csv")
intro_section2 <- read.csv("C:/Users/jaeye/Downloads/WB/State profile/Intro/section2_merged_all.csv")
intro_section3 <- read.csv("C:/Users/jaeye/Downloads/WB/State profile/Intro/section3_intro.csv")


# Tab 2a: Labour Market 
labour_profile_df <- read.csv("C:/Users/jaeye/Downloads/WB/State profile/Labour/merged_labour_intro_1.csv")
labour_intro2 <- read.csv("C:/Users/jaeye/Downloads/WB/State profile/Labour/merged_labour_intro_2.csv")

labour_df <- read.csv("C:/Users/jaeye/Downloads/WB/State profile/Labour/Section1_2_merged_labour_jqi_all.csv")
wage_quintile <- read.csv("C:/Users/jaeye/Downloads/WB/State profile/Labour/Section3_merged_wage_quintile.csv") 

#Welfare--monetary#
# Tab 3a: Monetary Welfare
hces1     <- read_csv("C:/Users/jaeye/Downloads/WB/State profile/Welfare/Graph1_hces_pov_all.csv")    
hces2  <- read_csv("C:/Users/jaeye/Downloads/WB/State profile/Welfare/Graph3_hces_income_all.csv")  
hces3 <- read_csv("C:/Users/jaeye/Downloads/WB/State profile/Welfare/Graph2_hces_welfare_all_2.csv") 


#Tab 3b: Welfare--nonmonetary#
nonmon_1 <- read_csv("C:/Users/jaeye/Downloads/WB/State profile/Welfare/Graph1_nfhs_pov_all.csv")
nonmon_2 <- read_csv("C:/Users/jaeye/Downloads/WB/State profile/Welfare/Graph2_nfhs_wealth_all.csv")
nonmon_3 <- read_csv("C:/Users/jaeye/Downloads/WB/State profile/Welfare/Graph3_nfhs_components_all.csv")


#Schemes#
#Tab 4a: 
monetary <- read.csv("C:/Users/jaeye/Downloads/WB/State profile/Schemes/hces2022_2011.csv")
# Tab 4a-2
graph2_mp <- read.csv("C:/Users/jaeye/Downloads/WB/State profile/Schemes/hces_schemes_poor.csv")


#Tab 4b:
nonmonetary <- read.csv(  "C:/Users/jaeye/Downloads/WB/State profile/Schemes/nfhs2015_2019_mpi.csv")
# Tab 4b-2:
graph2_nm <- read_csv("C:/Users/jaeye/Downloads/WB/State profile/Schemes/graph2-nfhsschemes.csv")

#Comparison#
comp <- read.csv("C:/Users/jaeye/Downloads/WB/State profile/comparison/statecomp_15sep.csv")
comp_xlsx_data   <- read.xlsx("C:/Users/jaeye/Downloads/WB/State profile/data/statecomp.xlsx", sheet = 1)
comp_xlsx_readme <- read.xlsx("C:/Users/jaeye/Downloads/WB/State profile/data/statecomp.xlsx", sheet = 2, colNames = FALSE)

# Fiscal Profile source workbook
source("C:/Users/jaeye/Downloads/WB/State profile/pfr_excel_loader.R", local = TRUE)
pfr_workbook <- "C:/Users/jaeye/Downloads/WB/State profile/India PFR Tool 1.xlsx"
pfr_loaded <- load_pfr_data_from_workbook(pfr_workbook)

# Fiscal Profile (PFR 1_1)
pfr_data <- pfr_loaded$pfr_data

# Revenues (PFR 2_1)
pfr_2_1_data <- pfr_loaded$pfr_2_1_data

# Expenditure (PFR 3_1)
pfr_3_1_data <- pfr_loaded$pfr_3_1_data
rm(pfr_loaded)
...
#exptool_table table td:first-child {
    ...
    dashboardSidebar(
      sidebarMenu(
        ...
        menuItem("Access to Schemes", icon=icon("hands-helping"),
                 menuSubItem("By Monetary Poverty", tabName="tab4a"),
      ...
      tabItems(
            ...
            column(
              ...
              tags$em(
                ...
                HTML(paste0(
                  ...
                  "Household Consumer Expenditure Survey (HCES), 2023-24;<br>",
        ...
        tabItem(
                       ...
                       fluidRow(
                         column(6,
                                div(style = "min-height:160px;",
                                    selectizeInput("fiscaltool_structural", "Peer Group 1:",
                         ...
                         column(6,
                                div(style = "min-height:160px;",
                                    selectizeInput("fiscaltool_peers", "Peer Group 2:",
                                                   choices  = pfr_all_states,
                                                   selected = NULL,
                                                   multiple = TRUE,
                                                   options  = list(placeholder = "Click to add states...",
                       ...
                       fluidRow(
                         column(12,
                                div(style = "text-align:center; margin-top:10px; margin-bottom:6px;",
                                    actionButton("fiscaltool_run", "Run",
                                                 style = "font-size:16px; font-weight:bold; padding:8px 40px; background-color:#003366; color:white; border:none; border-radius:4px;")
                                )
                         )
                       )
                   )
          ...
          wellPanel(
            tags$p(
              tags$strong("Note: "),
              "Fiscal Profile presents key macro-fiscal indicators for the selected state, ",
              "expressed as a percentage of GDP or in levels, alongside peer-group averages for comparison. ",
              "Key indicators include: Nominal GDP and GDP per capita, inflation (CPI), fiscal balance, outstanding liabilities, ",
              "total revenues and expenditure, and their main components. ",
              tags$em("Source: RBI State Finances, MOSPI, NITI Aayog.")
            )
          )
        ...
        tabItem(
          ...
          fluidRow(
            column(12, align = "right",
                   tags$em(
                     style = "display:block; margin-bottom:40px;",
                     "Source: RBI State Finances, MOSPI, NITI Aayog, India PFR Tool (World Bank),<br>"
                   )
            )
          )
        ...
        tabItem(
            ...
            column(12,
                   box(width = 12,
                       ...
                       fluidRow(
                         column(6,
                                div(style = "min-height:160px;",
                                    selectizeInput("revtool_structural", "Peer Group 1:",
                                                   choices  = pfr_all_states,
                                                   selected = NULL,
                                                   multiple = TRUE,
                                                   options  = list(placeholder = "Click to add states...",
                         ...
                         column(6,
                                div(style = "min-height:160px;",
                                    selectizeInput("revtool_peers", "Peer Group 2:",
                                                   choices  = pfr_all_states,
                                                   selected = NULL,
                                                   multiple = TRUE,
                                                   options  = list(placeholder = "Click to add states...",
          ...
          wellPanel(
            tags$p(
              tags$strong("Note: "),
              "Revenues shows the composition of state fiscal revenues as a percentage of GDP and as a share of total revenues. ",
              "Total Revenues = Current Revenues + Recovery of Loans & Advances + Miscellaneous Capital Receipts. ",
              "Current Revenues = Tax Revenues + Non-Tax Revenues. ",
              "Tax Revenues = State's Own Tax Revenue + Share in Central Government Tax. ",
              "Non-Tax Revenues = State's Own Non-Tax Revenue + Grants from the Centre. ",
              tags$em("Source: RBI State Finances.")
            )
          )
        ...
        tabItem(
            ...
            column(12,
                   box(width = 12,
                       ...
                       fluidRow(
                         column(6,
                                div(style = "min-height:160px;",
                                    selectizeInput("exptool_structural", "Peer Group 1:",
                                                   choices  = pfr_all_states,
                                                   selected = NULL,
                                                   multiple = TRUE,
                                                   options  = list(placeholder = "Click to add states...",
                         ...
                         column(6,
                                div(style = "min-height:160px;",
                                    selectizeInput("exptool_peers", "Peer Group 2:",
                                                   choices  = pfr_all_states,
                                                   selected = NULL,
                                                   multiple = TRUE,
                                                   options  = list(placeholder = "Click to add states...",
          ...
          wellPanel(
            tags$p(
              tags$strong("Note: "),
              "Expenditure shows the functional classification of state public expenditure as a percentage of GDP and as a share of total expenditure. ",
              "Total Expenditure = Current Expenditure + Capital Outlay + Loans & Advances. ",
              "Current Expenditure includes Current Developmental Expenditure (Social Services and Economic Services) and Current Non-Developmental Expenditure (General Services). ",
              "Capital Outlay includes Development Capital Outlay (Social and Economic Services) and Non-Development Capital Outlay. ",
              "Loans & Advances cover Development Purposes and Non-Development Purposes. ",
              tags$em("Source: RBI State Finances.")
            )
          )
        ...
        tabItem(
          ...
          wellPanel(
            tags$p(
              tags$strong("Note: "),
              "Fiscal Health Index (FHI), developed by NITI Aayog, is a composite indicator that benchmarks states' fiscal performance ",
              "across dimensions such as quality of expenditure, revenue mobilization, fiscal prudence, debt index, and debt sustainability. ",
              "Charts show Total Development Expenditure (% of GSDP), Total Capital Outlay (% of GSDP), and Quality of Expenditure Index. ",
              tags$em("Source: WBG Staff Calculations based on RBI State Finances.")
            )
          )
          ...
          fluidRow(
            column(3,
                   selectInput("labprof_state", "Select State:",
                               choices = c("National" = "India",
                                           sort(setdiff(unique(labour_profile_df$state), "India"))),
                               selected = "India")
            ),
            column(3,
                      ...
                      fluidRow(
                        column(3,
                               selectInput("lab_quality_year", "Select Year:",
                                           choices = sort(setdiff(unique(labour_df$year), 2011)))
        ...
        tabItem(tabName = "tab3a",
                    ...
                    box(
                      ...
                      wellPanel(
                        ...
                        tags$ol(
                          ...
                          tags$li("For brevity, 2011-12 is referred to as 2011 on the graph, and similarly for all years."),
                          tags$li(
                            "Changes between 2022 and 2023 should not be read in isolation as they reflect a combination of welfare gains and improved data collection. ",
                            "For India's progress on poverty reduction, readers are requested to compare 2011 to 2023. ",
                            tags$a(
                              href = "https://documents.worldbank.org/en/publication/documents-reports/documentdetail/099042126035038379",
                              target = "_blank",
                              "World Bank (2026), India's long-term poverty trend, 2011-12 to 2023-24"
                            ),
                            "."
                          )
                        )
                ...
                fluidRow(
                  ...
                  column(12, align = "right",
                         tags$em( style = "display:block; margin-bottom:0;",
                                  "Source: Data on household consumption expenditure across categories is sourced from NSS 2011 and HCES 2023-24."))
                )
  ...
  ")
                  ...
                  fluidRow(
                    ...
                    column(12, align = "right",
                           tags$em(style = "display:block; margin-bottom:0;", 
                                   "Source: Calculations from NFHS 2015-16 and 2019-21."))
                  )
                )
        ),
                   ...
                   selectInput(
                     ...
                     choices = list(
                       ...
                       "Poverty Measures" = list(
                         "Extreme Poverty ($3.00 PPP), Year 2023" = "poor_300_2023",
                         "Extreme Poverty ($3.00 PPP), Year 2022" = "poor_300_2022",
                         "Extreme Poverty ($3.00 PPP), Year 2011" = "poor_300_2011",
                         "LMIC Poverty ($4.20 PPP), Year 2023" = "poor_420_2023",
                         "LMIC Poverty ($4.20 PPP), Year 2022" = "poor_420_2022",
                         "LMIC Poverty ($4.20 PPP), Year 2011" = "poor_420_2011",
              ...
              box(
                ...
                div(
                 ...
                 margin-top: 10px;",
                      ...
                      tags$ul(
                        tags$li(
                          tags$strong("Monetary poverty (% HHs in poverty, 2011, 2022 and 2023): "),
                          ...
                          "Estimates are based on the Household Consumption Expenditure Survey (HCES) 2011-12, 2022-23 and 2023-24."
                        ),
                        tags$li(
                ...
                fluidRow(
                  ...
                  column(4,
                         selectInput("mp_indicators", "Select up to 3 Indicators:",
                                    ...
                                    selected = c("food_pds_subs", "food_pds_free"),
                                    multiple = TRUE,
                                    selectize = TRUE
                         )
                  ),
                ...
                fluidRow(
                  column(12,
                         box(width = 12, 
                             ...
                             fluidRow(
                               column(3,
                                      selectInput("mp_access_year", "Year:",
                                                  choices = c("2011-12" = 2011, "2022-23" = 2022, "2023-24" = 2023),
                                                  selected = 2023)
                               )
                             ),
        ...
        tabItem(tabName = "tab4b",
                ...
                fluidRow(
                  ...
                  column(12, align = "right",
                         tags$em(style = "display:block; margin-bottom:0;",
                                 "Data is sourced from National Family Health Surveys. Round 4 (conducted 2015 - 16) and Round 5 (conducted 2019 - 21) have been included in this analysis."))
                )
        ),
              ...
              box(
                ...
                div(
                 ...
                 margin-top: 10px;",
                      ...
                      tags$p(tags$strong("Source: Household Consumption Expenditure Survey, 2023-24")),
                      tags$ul(
...
server <- function(input, output, session) {
  ...
  fmt_whole_comma <- function(x) {
    ifelse(is.na(x), "", format(round(x, 0), big.mark = ",", scientific = FALSE, trim = TRUE))
  }
  axis_whole <- function(title = "", range = NULL) {
    axis <- list(title = title, tickformat = ",.0f")
  ...
  # Sync state selection across the 5 Macroeconomics & Fiscal Indicators tabs
  fiscal_state_ids <- c("fiscaltool_state", "fiscal_state",
                        "revtool_state", "exptool_state", "fhi_state")
  lapply(fiscal_state_ids, function(id) {
    observeEvent(input[[id]], {
      new_val <- input[[id]]
      req(new_val)
      for (other in setdiff(fiscal_state_ids, id)) {
        if (!isTRUE(input[[other]] == new_val)) {
  ...
  output$tile_gva_share <- renderValueBox({
    ...
    txt <- if (is.na(val) || length(val) == 0) {
      ...
      paste0(formatC(val, format = "f", digits = 0), "%")
    }
  ...
  output$gva_chart <- renderPlotly({
    ...
    plot_ly(
      ...
      values = ~Value,
      type   = 'pie',
      hole   = 0.5, text = ~paste0(Sector, ": ", fmt_pct1(Value * 100)),
      textinfo = "text",
      hovertext = ~paste0(Sector, "<br>", fmt_pct1(Value * 100)),
      hoverinfo = "text",
  ...
  output$gender_comp_plot <- renderPlotly({
    ...
    plot_ly(
      ...
      values = ~Value,
      type = "pie",
      text = ~paste0(Gender, ": ", fmt_pct1(Value)), 
      textinfo = "text",
  ...
  output$working_age_plot <- renderPlotly({
    ...
    plot_ly(
      ...
      y = ~Value,
      type = "bar",
      text = ~paste0("<b>", fmt_pct1(Value), "</b>"),  
      textposition = "auto",
      ...
      layout(
        ...
        yaxis = axis_whole("Percentage (%)", c(0, 100)),
        xaxis = list(title = ""),
  ...
  output$edu_comp_plot <- renderPlotly({
    ...
    plot_ly(
      ...
      colors = c("Female" = "#f55f74", "Male" = "#007191", "All" = "#4a2377"),
      type = "bar",
      hovertext = ~paste0(Education_Level, "<br>", Sex, ": ", fmt_pct1(Value)),
      hoverinfo = "text"
    ) %>%
      layout(
        barmode = "group",
  ...
  output$voc_train_plot <- renderPlotly({
    ...
    plot_ly(
      ...
      y = ~Value,
      type = "bar",
      text = ~paste0("<b>", fmt_num1(Value), "</b>"),
      textposition = "auto",
    ...
    df_plot <- df %>%
      ...
      dplyr::mutate(
        ...
        tooltip = paste0("Year: ", year, "<br>Value: ",
                         if (SCALE_TO_PERCENT) fmt_pct1(value) else fmt_num1(value))
      )
  ...
  output$emp_sector_chart <- renderPlotly({
    ...
    plot_ly(sector_data, x = ~sector, y = ~value, type = 'bar',
            text = ~fmt_pct1(value), textposition = 'auto',
  ...
  output$real_income_bar <- renderPlotly({
    ...
    df_plot <- df %>%
      ...
      dplyr::ungroup() %>%
      dplyr::mutate(
        label = fmt_whole_comma(real_wage_23),
    ...
    plot_ly(df_plot, x = ~quint_label, y = ~real_wage_23,
            ...
            hoverinfo = "text",
            marker = list(color = ~color)) %>%
      layout(yaxis = axis_whole("Real Earnings (INR/day)"),
  ...
  output$welfare_mon1 <- renderPlotly({
    ...
    df_long <- df %>%
      ...
      mutate(
        ...
        headcount_label = fmt_num1(headcount)
      )
    ...
    #years
    df_long <- df_long %>%
      filter(year %in% c(2011, 2022, 2023)) %>%
    ...
    plot_ly(
      ...
      layout(
        xaxis = list(title = "Year", type = "category", categoryorder = "array", categoryarray = as.character(2011:2023), tickmode = "array", tickvals = as.character(2011:2023), ticktext = as.character(2011:2023)),
        yaxis = axis_whole("", c(0, 100)),
  ...
  output$welfare_mon2 <- renderPlotly({
    ...
    df_long <- df %>%
      ...
      mutate(
        ...
        tooltip_text = paste0("Year: ", year,
                              ...
                              "<br>Welfare: ", fmt_whole_comma(welfare_agg21_sp))
      )
    
    
    
    year_colors <- c("2011" = "#d31f11", "2022" = "#007191", "2023" = "#f47a00")
    ...
    plot_ly(
      ...
      hoverinfo = "text",
      text = ~fmt_whole_comma(welfare_agg21_sp),
      textposition = "auto",
  ...
  output$nonmon_graph1 <- renderPlotly({
    ...
    plot_ly(
      ...
      layout(
        xaxis = list(title = "Year", type = "category", categoryorder = "array", categoryarray = as.character(2015:2019), tickmode = "array", tickvals = as.character(2015:2019), ticktext = as.character(2015:2019)),
        yaxis = axis_whole("Headcount (%)", c(0, 100)),
  ...
  output$nonmon_graph2 <- renderPlotly({
    ...
    plot_ly(
      ...
      layout(
        ...
        bargroupgap = 0.0,
        xaxis = list(title = ""),
        yaxis = axis_whole("Share of Households (%)", c(0, 100)),
  ...
  output$welfare_nonmon3_poor <- renderPlotly({
    ...
    plot_ly(
      ...
      layout(
        ...
        yaxis = axis_whole("Share (%)", c(0, 100)),
  ...
  output$monetary_bar <- renderPlotly({
    req(input$mp_state, input$mp_sector, input$mp_indicators, input$mp_access_year)
    ...
    df <- monetary %>%
      filter(
        ...
        year == as.numeric(input$mp_access_year),
        sector == sec
      )
        # Pivot longer
    df_long <- df %>%
  ...
  filtered_data_mp_poor <- reactive({
    ...
    graph2_mp %>%
      ...
      mutate(
        ...
        year_label      = factor(year, levels = c(2011, 2022, 2023), labels = c("2011-12", "2022-23", "2023-24")),
        value_percent   = value*100,
        value_label = ifelse(is.na(value_percent), "",
                             fmt_pct1(value_percent))
  ...
  render_nm_plot <- function(df, palette) {
    ...
    df_long <- df %>%
      ...
      mutate(
        ...
        value_percent = value * 100,
        value_label = fmt_pct1(value_percent)
      )
  ...
  percent_vars <- c(
    ...
    "poor_300_2011", "poor_300_2022", "poor_300_2023",
    "poor_420_2011", "poor_420_2022", "poor_420_2023",
  ...
  write_fiscal_sheet <- function(wb, sheet_name, title, subtitle,
    ...
    headers <- c("Indicator", as.character(all_years),
                 state_display, "Peer Group 1", "Peer Group 2")
    ...
    for (rdef in row_defs) {
      ...
      # Summary columns: State | Peer Group 1 | Peer Group 2
      ...
      sum_vals  <- list(sv, stv, prv)
      sum_keys  <- c("state", "struct", "peers")
  ...
  # Render Excel-like HTML table (triggered by Run button)
  observeEvent(input$fiscaltool_run, {
    output$fiscaltool_table <- renderUI({
      ...
      # Compute averages per code for both groups
      structural_avg <- list(); peers_avg <- list()
      ...
      # Total columns: Indicator + Trend + years + State + PeerGroup1 + PeerGroup2 + Last + Count1 + Count2
      n_total_cols <- length(all_years) + 8
      ...
      header_html <- paste0(
        ...
        '<th style="background:#5b3a8c; color:white; padding:8px 8px; text-align:center;
          font-size:12px; min-width:70px; position:sticky; top:0;">Peer Group 1</th>',
        '<th style="background:#6b3a2a; color:white; padding:8px 8px; text-align:center;
          font-size:12px; min-width:70px; position:sticky; top:0;">Peer Group 2</th>',
        '<th style="background:#003366; color:white; padding:8px 6px; text-align:center;
      ...
      for (rdef in fiscaltool_row_defs) {
        ...
        # Count 1 (Peer Group 1 with data)
        ...
        # Count 2 (Peer Group 2 with data)
  ...
  })  # end observeEvent fiscaltool_run
  ...
  output$download_fiscaltool <- downloadHandler(
    ...
    content = function(file) {
      ...
      write_fiscal_sheet(wb, "Fiscal Profile",
                         ...
                         yr_min, yr_max, calc_mode, structural_st, character(0), peers_st)
  ...
  # Render Revenues table (triggered by Run button)
  observeEvent(input$revtool_run, {
  ...
  rev_stacked_chart <- function(sel_state, yr_min, yr_max, components, colors,
    ...
    if (show_summary) {
      x_labels <- c(x_labels, "", state_display, "Peer Group 1", "Peer Group 2")
    }
  ...
  # ---- Revenue charts (triggered by Run button) ----
  observeEvent(input$revtool_run, {
    ...
    output$rev_fiscal_gdp_chart <- plotly::renderPlotly({
      ...
      rev_stacked_chart(sel_state, yr_min, yr_max, components, colors,
                        show_summary = TRUE, structural_st, character(0), peers_st,
                        calc_mode = input$revtool_calc)
    })
    ...
    output$rev_fiscal_total_chart <- plotly::renderPlotly({
      ...
      rev_stacked_chart(sel_state, yr_min, yr_max, components, colors,
                        show_summary = FALSE, structural_st, character(0), peers_st,
                        calc_mode = input$revtool_calc)
    })
  ...
  })  # end observeEvent revtool_run (charts)
  ...
  # Render Expenditure table (triggered by Run button)
  observeEvent(input$exptool_run, {
    output$exptool_table <- renderUI({
      ...
      header_html <- paste0(
        ...
        '<th style="background:#5b3a8c; color:white; padding:8px 8px; text-align:center; font-size:12px; min-width:70px; position:sticky; top:0;">Peer Group 1</th>',
        '<th style="background:#6b3a2a; color:white; padding:8px 8px; text-align:center; font-size:12px; min-width:70px; position:sticky; top:0;">Peer Group 2</th>',
        ...
        '<th style="background:#6b3a2a; color:white; padding:8px 6px; text-align:center; font-size:12px; min-width:50px; position:sticky; top:0;">Count 2</th>',
        '</tr>'
      )
  ...
  exp_stacked_chart <- function(sel_state, yr_min, yr_max, components, colors,
    ...
    if (x_mode == "years") {
      ...
      x_labels <- c(state_display, "Peer Group 1", "Peer Group 2")
    }
  ...
  # ---- Expenditure charts (triggered by Run button) ----
  observeEvent(input$exptool_run, {
    ...
    output$exp_func_gdp_chart <- plotly::renderPlotly({
      ...
      exp_stacked_chart(input$exptool_state, input$exptool_years[1], input$exptool_years[2],
                        comps, exp_chart_colors, "years", structural_st, character(0), peers_st,
                        calc_mode = input$exptool_calc)
    })
    ...
    output$exp_func_gdp_comp_chart <- plotly::renderPlotly({
      ...
      exp_stacked_chart(input$exptool_state, input$exptool_years[1], input$exptool_years[2],
                        comps, exp_chart_colors, "summary", structural_st, character(0), peers_st,
                        calc_mode = input$exptool_calc)
    })
  ...
  })  # end observeEvent exptool_run (charts)

...
hces1     <- read_csv("C:/Users/jaeye/Downloads/State profile/Welfare/Graph1_nfhs_pov_all.csv")    
hces2  <- read_csv("C:/Users/jaeye/Downloads/State profile/Welfare/Graph3_nfhs_components_all.csv")  
hces3 <- read_csv("C:/Users/jaeye/Downloads/State profile/Welfare/Graph2_nfhs_wealth_all.csv") 
...
server <- function(input, output, session) {
  ...
  output$nmw_demo_value_ui <- renderUI({
    ...
    # own_house
    if (input$nmw_demo_var == c("own_house", "agri_land")) {
  ...
  output$nmwcomp_demo_value_ui <- renderUI({
    ...
    values <- sort(na.omit(unique(nonmon_3[[input$nmwcomp_demo_var]])))
    
    if (input$nmwcomp_demo_var == c("own_house", "agri_land"))  {
      label_map <- setNames(c("No", "Yes"), c("0", "1"))
      values <- intersect(names(label_map), as.character(values))
      choices_named <- setNames(values, label_map[values])
    } else {
